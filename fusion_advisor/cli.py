...
def main(
    ...
    if vs_inductor:
        report.console.print("\n--vs-inductor needs a GPU; skipped.", style="yellow")
    report.console.print("\nNot benchmarked - numerics and speedup need a CUDA GPU.", style="dim")

    if json_out:
        payload = build_payload(
            clusters, estimates, ranges, diffs, [None] * len(clusters), rejections
        )
